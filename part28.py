'''
#############
 WARNING : Taken from https://github.com/sfstpala/SlowSHA
#############
'''
...
class SHA1 (object):
    ...
    def __init__(self, message, h0 = 0x67452301, h1 = 0xefcdab89, h2 = 0x98badcfe, h3 = 0x10325476, h4 = 0xc3d2e1f0, length = None):
        self._h0 = h0
        self._h1 = h1
        self._h2 = h2
        self._h3 = h3
...
def sendMAC(key, message):
    return (SHA1(key + message).digest(), message)

if __name__=='__main__':
    k = b'YELLOW SUBMARINE'
    m = b'money in the bank, pimpin aint easy'
